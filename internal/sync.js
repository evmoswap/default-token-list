...
const { ChainId } = require("@evmoswap/core-sdk");
...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the evmoswap/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("evmoswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/evmoswap/icons/master/token/${icon}.png`;
